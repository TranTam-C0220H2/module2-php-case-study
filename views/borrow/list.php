...
<div class="card">
    ...
    <div class="card-body">
        <form action="index.php?pages=borrow&actions=search" method="get" class="card card-sm">
    ...
    <div class="card-body"><a href="index.php?pages=borrow&actions=addBorrow">Add new borrow</a></div>
    <div class="card-body">
