        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="name"
                       value="<?php echo isset($_SESSION['name']) ? $_SESSION['name'] : $name ?>">
                <div class="col-md-9">
                    <?php
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control" name="email"
                       value="<?php echo isset($_SESSION['email']) ? $_SESSION['email'] : $email ?>">
                <?php
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="phone"
                       value="<?php echo isset($_SESSION['phone']) ? $_SESSION['phone'] : $phone ?>">
                <?php
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" name="birthDay"
                       value="<?php echo isset($_SESSION['birthDay']) ? $_SESSION['birthDay'] : $birthDay ?>">
                <?php
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="address"
                       value="<?php echo isset($_SESSION['address']) ? $_SESSION['address'] : $address ?>">
                <?php
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="note"
                       value="<?php echo isset($_SESSION['note']) ? $_SESSION['note'] : $note ?>">
                <div class="col-md-9">
                    <?php
            ...
            <a class="btn btn-primary" href="index.php?pages=student">Cancel</a>
        </form>
    </div>
